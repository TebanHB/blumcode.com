...
export default function Footer({
  ...
  return (
    ...
    >
      <div className="absolute left-0 top-0 h-32 w-32 rounded-full bg-blum-blue/8 blur-xl md:h-40 md:w-40 md:blur-2xl" />
      <div className="absolute bottom-0 right-0 h-36 w-36 rounded-full bg-blum-yellow/5 blur-xl md:h-44 md:w-44 md:blur-2xl" />

      <div className="relative mx-auto max-w-7xl">
        <div className="rounded-[24px] border border-white/10 bg-white/5 p-6 shadow-[0_12px_28px_rgba(0,0,0,0.16)] sm:rounded-[30px] sm:p-8">
