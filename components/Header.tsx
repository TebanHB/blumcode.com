        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/60 bg-white/85 shadow-[0_8px_24px_rgba(15,23,42,0.06)] backdrop-blur-md">
          ...
          <div className="relative flex h-18 items-center justify-between px-4 sm:h-20 sm:px-6">
            ...
            <div className="hidden items-center md:flex">
              <Link
                href={`/${otherLang}`}
                className="group inline-flex items-center gap-2 rounded-full border border-black/10 bg-white/90 px-3 py-2 text-sm font-medium text-gray-700 shadow-sm transition duration-300 hover:border-blum-blue hover:text-blum-blue lg:px-4"
              >
