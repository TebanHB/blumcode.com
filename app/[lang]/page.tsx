...
const dictionary: Record<Locale, Dictionary> = {
  ...
  en: {
    ...
    hero: {
      ...
      title1: "Tailored Software",
      title2: "Development",
      title3: "for your",
      rotatingWords: ["Business", "Company", "Project", "Community"],
      description:
        "At BlumCode, we turn your ideas into innovative technology solutions. We build custom software, improve existing systems, and provide ongoing support to help your business grow.",
      primary: "Request a Quote",
      secondary: "View Our Services",
      cards: {
        webTitle: "Web",
        webDescription: "Modern, professional applications",
        mobileTitle: "Mobile",
        mobileDescription: "Clean, responsive experiences",
        supportTitle: "Support",
        supportDescription: "Continuity, improvements, and growth",
      },
      floatingCard: {
